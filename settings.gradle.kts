...
include(":features:quiz:quiz-ui")
include(":features:quiz:quiz-panes")
include(":features:quiz:quiz-presentation")
include(":features:quiz:quiz-routes")
include(":features:quiz:quiz-di")
...
include(":games:tetris:tetris-app")
include(":games:tetris:tetris-presentation")
include(":games:tetris:tetris-ui")
include(":map-editor:map-editor-app")
include(":map-editor:map-editor-features:map-editor-list:map-editor-list-di")
include(":map-editor:map-editor-features:map-editor-list:map-editor-list-panes")
include(":map-editor:map-editor-features:map-editor-list:map-editor-list-presentation")
include(":map-editor:map-editor-features:map-editor-list:map-editor-list-routes")
include(":map-editor:map-editor-features:map-editor-list:map-editor-list-ui")
include(":map-editor:map-editor-features:map-editor-list:map-editor-list-ui-models")
include(":map-editor:map-editor-features:map-editor-detail:map-editor-detail-di")
include(":map-editor:map-editor-features:map-editor-detail:map-editor-detail-panes")
include(":map-editor:map-editor-features:map-editor-detail:map-editor-detail-presentation")
include(":map-editor:map-editor-features:map-editor-detail:map-editor-detail-routes")
include(":map-editor:map-editor-features:map-editor-detail:map-editor-detail-ui")
include(":map-editor:map-editor-features:map-editor-detail:map-editor-detail-ui-models")
include(":shared:core")
...
include(":style:components:map:map-ui")
include(":style:components:map:map-ui-models")
