...
include(":theme-m3:speakers:speakers-sample")
include(":theme-m3:speakers:speakers-panes")
include(":theme-m3:speakers:speakers-presentation")
include(":theme-m3:speakers:speakers-semantics")
include(":theme-m3:speakers:speakers-di")
include(":theme-m3:speakers:speakers-test")
include(":theme-m3:speakers:speakers-test-scopes")
