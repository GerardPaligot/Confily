...
object BottomActions {
    val agenda = BottomAction(
        ...
        icon = RVitamin.drawable.ic_vtmn_calendar_line,
        iconSelected = RVitamin.drawable.ic_vtmn_calendar_fill,
        label = R.string.screen_agenda,
        contentDescription = null
    )
    val speakers = BottomAction(
        route = Screen.SpeakerList.route,
        icon = RVitamin.drawable.ic_vtmn_mic_line,
        iconSelected = RVitamin.drawable.ic_vtmn_mic_fill,
    ...
    val partners = BottomAction(
        ...
        icon = RVitamin.drawable.ic_vtmn_earth_line,
        iconSelected = RVitamin.drawable.ic_vtmn_earth_fill,
    ...
    val info = BottomAction(
        ...
        icon = RVitamin.drawable.ic_vtmn_information_line,
        iconSelected = RVitamin.drawable.ic_vtmn_information_fill,
        contentDescription = null,
