...
package com.paligot.confily.backend.export.infrastructure.firestore
...
import com.paligot.confily.backend.menus.infrastructure.firestore.convertToModel
...
fun EventEntity.convertToModelV5(
    ...
    contact = EventContact(
        ...
        socials = this.socials.map { it.convertToModel() }
    ),
