package com.paligot.conferences.backend.database
...
interface Database {
    ...
    suspend fun <T : Any> getAll(clazz: KClass<T>): List<T>
    ...
    suspend fun <T : Any> query(eventId: String, clazz: KClass<T>, vararg ops: WhereOperation): List<T>
    suspend fun <T : Any> insert(id: String, item: T)
    suspend fun <T : Any> insert(eventId: String, id: String, item: T)
    suspend fun <T : Any> insert(transform: (id: String) -> T): String
    suspend fun <T : Any> insert(eventId: String, transform: (id: String) -> T): String
    suspend fun <T : Any> update(id: String, item: T)
...
suspend inline fun <reified T : Any> Database.get(eventId: String, id: String): T? = get(eventId, id, T::class)
suspend inline fun <reified T : Any> Database.getAll(): List<T> = getAll(T::class)
suspend inline fun <reified T : Any> Database.getAll(eventId: String): List<T> = getAll(eventId, T::class)
suspend inline fun <reified T : Any> Database.query(vararg ops: WhereOperation): List<T> = query(T::class, *ops)
suspend inline fun <reified T : Any> Database.query(eventId: String, vararg ops: WhereOperation): List<T> =
