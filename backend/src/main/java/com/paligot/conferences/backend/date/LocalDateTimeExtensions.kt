package com.paligot.conferences.backend.date
...
fun LocalDateTime.format(pattern: FormatterPattern): String = format(DateTimeFormatter.ofPattern(pattern.format))